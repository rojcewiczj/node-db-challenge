...
A-Relational databases store data, and SQL manipulates databases.
- [ ] Why do tables need a `primary key`?
A- So that there is a unique identifier for every entery.
- [ ] What is the name given to a table column that references the primary key on another table.
A-foreign key
- [ ] What do we need in order to have a _many to many_ relationship between two tables.
-a third table which links the two tables based on two sets of foreign keys and one set of primary keys. 
